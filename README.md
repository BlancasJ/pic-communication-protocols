...
|-----------|------------|------------|
| `temperature/` | Reads LM35 every 20ms via timer, sends temperature to slave (addr 0xa0) | Receives ADC value, converts to Celsius (x0.4882), displays on LCD |
...
|-----------|------------|--------------|
| `temp/` | Reads LM35 every ~800ms, sends formatted temperature float at 9600 baud | Displays received temperature on LCD |
